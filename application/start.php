...
// We need to load up our config class
require_once 'application/libraries/core/config.php';

Laravel\Event::listen(Core\Config::loader, function($bundle, $file)
{
	return Core\Config::file($bundle, $file);
});
